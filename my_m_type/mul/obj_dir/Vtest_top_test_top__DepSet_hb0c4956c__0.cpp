            ...
            if ((4U & (IData)(vlSelf->__PVT__exe_mem_mem_op_o))) {
                ...
                vlSelf->__PVT__mem0__DOT__reg_wdata 
                    = ((1U & (IData)(vlSelf->__PVT__exe_mem_mem_op_o))
                        ? vlSymsp->TOP__test_top__data_ram0.__PVT__data_o
                        : ((0U == (3U & vlSelf->__PVT__exe_mem_mem_addr_o))
                            ? (((- (IData)((1U & (vlSymsp->TOP__test_top__data_ram0.__PVT__data_o 
                                                  >> 0xfU)))) 
                                << 0x10U) | (0xffffU 
                                             & vlSymsp->TOP__test_top__data_ram0.__PVT__data_o))
                            : ((2U == (3U & vlSelf->__PVT__exe_mem_mem_addr_o))
                                ? (((- (IData)((vlSymsp->TOP__test_top__data_ram0.__PVT__data_o 
                                                >> 0x1fU))) 
                                    << 0x10U) | (vlSymsp->TOP__test_top__data_ram0.__PVT__data_o 
                                                 >> 0x10U))
                                : 0U)));
            } else if ((1U & (IData)(vlSelf->__PVT__exe_mem_mem_op_o))) {
                vlSelf->__PVT__mem0__DOT__reg_wdata 
                    = ((0U == (3U & vlSelf->__PVT__exe_mem_mem_addr_o))
                        ? (((- (IData)((1U & (vlSymsp->TOP__test_top__data_ram0.__PVT__data_o 
                                              >> 7U)))) 
                            << 8U) | (0xffU & vlSymsp->TOP__test_top__data_ram0.__PVT__data_o))
                        : ((1U == (3U & vlSelf->__PVT__exe_mem_mem_addr_o))
                            ? (((- (IData)((1U & (vlSymsp->TOP__test_top__data_ram0.__PVT__data_o 
                                                  >> 0xfU)))) 
                                << 8U) | (0xffU & (vlSymsp->TOP__test_top__data_ram0.__PVT__data_o 
                            ...
                            : ((2U == (3U & vlSelf->__PVT__exe_mem_mem_addr_o))
                                ...
                                : (((- (IData)((vlSymsp->TOP__test_top__data_ram0.__PVT__data_o 
                                                >> 0x1fU))) 
                                    << 8U) | (vlSymsp->TOP__test_top__data_ram0.__PVT__data_o 
                                              >> 0x18U)))));
            }
        }
    }
...
VL_INLINE_OPT void Vtest_top_test_top___nba_sequent__TOP__test_top__0(Vtest_top_test_top* vlSelf) {
    ...
    vlSelf->__PVT__id_exe_reg_we_o = ((1U & (~ (IData)(vlSymsp->TOP.rst_i))) 
                                      && ((1U & (~ (IData)(vlSelf->__PVT__exe_jump_enable_o))) 
                                          && ((IData)(
                                                      (0xcU 
                                                       == 
                                                       (0xcU 
            ...
            ? ((IData)(vlSelf->__PVT__exe0__DOT__exe_type_m0__DOT__is_q_operation)
                ...
                : ((vlSelf->__PVT__exe0__DOT__exe_type_m0__DOT__div0__DOT__result[2U] 
                    << 0x1fU) | (vlSelf->__PVT__exe0__DOT__exe_type_m0__DOT__div0__DOT__result[1U] 
                                 >> 1U))) : vlSelf->__PVT__exe0__DOT__exe_type_m0__DOT__div_result);
                                    ...
                                    ? 0U : ((0x40U 
                                             ...
                                             ? ((0x20U 
                                                ...
                                                ((0x10U 
                                                 ...
                                                 : 0U)
                                             : 0U))
                                : 0U) : ((1U & (IData)(vlSelf->__PVT__ctrl_stall_o))
    ...
    if (vlSymsp->TOP.rst_i) {
        ...
        __Vdly__if_id_inst_addr_o = 0U;
        vlSelf->__PVT__id_exe_rd_o = 0U;
        vlSelf->__PVT__id_exe_inst_addr_o = vlSelf->__PVT__id_exe_inst_addr_o;
        vlSelf->__PVT__id_exe_op2_o = 0U;
        vlSelf->__PVT__id_exe_op1_o = 0U;
        __Vdly__id_exe_inst_o = 0x13U;
        __Vtemp_21 = 0x13U;
    ...
    vlSelf->__PVT__if_id_inst_o = __Vtemp_21;
