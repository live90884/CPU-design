...
VL_ATTR_COLD void Vtest_top_test_top___ctor_var_reset(Vtest_top_test_top* vlSelf) {
    ...
    vlSelf->__PVT__exe0__DOT__b_jump_addr_o = VL_RAND_RESET_I(32);
    vlSelf->__PVT__exe0__DOT__b_jump_enable_o = VL_RAND_RESET_I(1);
    vlSelf->__PVT__exe0__DOT__m_reg_wdata_o = VL_RAND_RESET_I(32);
    ...
    vlSelf->__PVT__exe0__DOT__exe_type_b_j0__DOT__op1_eq_op2 = VL_RAND_RESET_I(1);
    vlSelf->__PVT__exe0__DOT__exe_type_b_j0__DOT__op1_ge_op2_signed = VL_RAND_RESET_I(1);
    vlSelf->__PVT__exe0__DOT__exe_type_b_j0__DOT__op1_ge_op2_unsigned = VL_RAND_RESET_I(1);
    vlSelf->__PVT__exe0__DOT__exe_type_m0__DOT__isType_m = VL_RAND_RESET_I(1);
    vlSelf->__PVT__exe0__DOT__exe_type_m0__DOT__a_o = VL_RAND_RESET_I(32);
    vlSelf->__PVT__exe0__DOT__exe_type_m0__DOT__b_o = VL_RAND_RESET_I(32);
    vlSelf->__PVT__exe0__DOT__exe_type_m0__DOT__div_result = VL_RAND_RESET_I(32);
    vlSelf->__PVT__exe0__DOT__exe_type_m0__DOT__is_q_operation = VL_RAND_RESET_I(1);
    vlSelf->__PVT__exe0__DOT__exe_type_m0__DOT__mult_req_o = VL_RAND_RESET_I(1);
    vlSelf->__PVT__exe0__DOT__exe_type_m0__DOT__div_req_o = VL_RAND_RESET_I(1);
    vlSelf->__PVT__exe0__DOT__exe_type_m0__DOT__mult_ready_i = VL_RAND_RESET_I(1);
    vlSelf->__PVT__exe0__DOT__exe_type_m0__DOT__div_ready_i = VL_RAND_RESET_I(1);
    vlSelf->__PVT__exe0__DOT__exe_type_m0__DOT__mult_result_i = VL_RAND_RESET_Q(64);
    vlSelf->__PVT__exe0__DOT__exe_type_m0__DOT__result = VL_RAND_RESET_I(32);
    vlSelf->__PVT__exe0__DOT__exe_type_m0__DOT__signed_adjust = VL_RAND_RESET_I(1);
    vlSelf->__PVT__exe0__DOT__exe_type_m0__DOT__invert_result = VL_RAND_RESET_Q(64);
    vlSelf->__PVT__exe0__DOT__exe_type_m0__DOT__mul0__DOT__reg32 = VL_RAND_RESET_I(32);
    VL_RAND_RESET_W(65, vlSelf->__PVT__exe0__DOT__exe_type_m0__DOT__mul0__DOT__result);
    vlSelf->__PVT__exe0__DOT__exe_type_m0__DOT__mul0__DOT__cnt = VL_RAND_RESET_I(6);
    vlSelf->__PVT__exe0__DOT__exe_type_m0__DOT__mul0__DOT__S = VL_RAND_RESET_I(3);
    vlSelf->__PVT__exe0__DOT__exe_type_m0__DOT__mul0__DOT__S_nxt = VL_RAND_RESET_I(3);
    vlSelf->__PVT__exe0__DOT__exe_type_m0__DOT__mul0__DOT__mul_add = VL_RAND_RESET_I(1);
    VL_RAND_RESET_W(65, vlSelf->__PVT__exe0__DOT__exe_type_m0__DOT__mul0__DOT__result_tmp);
    vlSelf->__PVT__exe0__DOT__exe_type_m0__DOT__div0__DOT__reg32 = VL_RAND_RESET_I(32);
    VL_RAND_RESET_W(65, vlSelf->__PVT__exe0__DOT__exe_type_m0__DOT__div0__DOT__result);
    vlSelf->__PVT__exe0__DOT__exe_type_m0__DOT__div0__DOT__cnt = VL_RAND_RESET_I(6);
    vlSelf->__PVT__exe0__DOT__exe_type_m0__DOT__div0__DOT__S = VL_RAND_RESET_I(3);
    vlSelf->__PVT__exe0__DOT__exe_type_m0__DOT__div0__DOT__S_next = VL_RAND_RESET_I(3);
    vlSelf->__PVT__exe0__DOT__exe_type_m0__DOT__div0__DOT__div_sub = VL_RAND_RESET_I(1);
    VL_RAND_RESET_W(65, vlSelf->__PVT__exe0__DOT__exe_type_m0__DOT__div0__DOT__result_tmp);
